lesson("About Arrays", function() {

  //We shall contemplate truth by testing reality, via spec expectations.
  learn("how to create arrays", function() {
    var emptyArray = [];
  ...
  learn("about array literals", function () {
    var array = [];
  ...
  learn("how to understand array length", function () {
  ...
  learn("how to slice arrays", function () {
  ...
  learn("about array references", function () {
  ...
  learn("how to push and pop", function () {
    var array = [1, 2];
    array.push(3);
  ...
  learn("how to shift arrays", function () {
    var array = [1, 2];
