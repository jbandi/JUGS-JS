lesson("About Objects", function () {
    ...
    lesson("Properties", function () {
        ...
        learn("that objects are collections of properties", function () {
            expect(meglomaniac.mastermind).toBe(FILL_ME_IN);
        });

        learn("that properties are case sensitive", function () {
            expect(meglomaniac.henchwoman).toBe(FILL_ME_IN);
            expect(meglomaniac.henchWoman).toBe(FILL_ME_IN);
        });
    });

    lesson("'in' keyword", function () {
        var meglomaniac;
        beforeEach(function () {
            meglomaniac = {
    ...
    learn("that properties that are functions act like methods", function () {
        var meglomaniac = {
            mastermind : "Brain",
            henchman: "Pinky",
    ...
    learn("that when a function is attached to an object, 'this' refers to the object", function () {
    ...
    learn("that properties can be added and deleted", function () {
    ...
    learn("how to use prototype to add to all objects", function () {
